    <style amp-custom>
        html,body,h1,h2,h3,h4,h5,h6,div,ul,li,p,pre,th,td,menu{margin:0;padding:0;}

        header,footer,section,article,aside,nav,menu,details{display:block;}
        html,body,abbr{border:0;}
        li{list-style:none;}
        ...
        body,select{    font-size-adjust: none;    -webkit-text-size-adjust: none;    font-size: 16px ;font-family:"微软雅黑";box-sizing: border-box;   -webkit-box-sizing: border-box;}
        ...
        .ztList a{ text-align: center;float: left;width: 33%;color: #606160;padding: 3px 0;margin-bottom: 5px;text-align:center;overflow:hidden; white-space:nowrap; overflow:hidden;}
